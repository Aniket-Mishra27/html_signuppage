<?php
    ...
    if (array_key_exists('u', $_POST) AND array_key_exists('p', $_POST)) {
        ...
        if ($_POST['u'] == '') {
            ...
            $query = "SELECT id FROM form WHERE email = '".mysqli_real_escape_string($link, $_POST['u'])."'";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                $query = "INSERT INTO form (email, password) VALUES ('".mysqli_real_escape_string($link, $_POST['u'])."', '".mysqli_real_escape_string($link, $_POST['p'])."')";
